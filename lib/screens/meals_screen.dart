  ...
  Widget build(BuildContext context) {
    ...
    if (!firstInit) {
      ...
      displayedMeals = categoryMeals.where((element) {
        if (widget.filters.isLactoseFree == true &&
            element.isLactoseFree != true) {
          return false;
        }
        if (widget.filters.isVegetarian == true &&
            element.isVegetarian != true) {
          return false;
        }
        ...
        if (widget.filters.isGlutenFree == true &&
            element.isGlutenFree != true) {
          return false;
        } else {
          return true;
        }
